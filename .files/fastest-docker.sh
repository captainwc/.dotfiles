...
### Update docker only
## UPDATE This File https://github.com/xjxjin/scripts/raw/main/check_docker_registry.sh
## Blog: https://blog.csdn.net/weixin_39504040/article/details/138994875
## sudo bash <(curl -sSL https://github.com/xjxjin/scripts/raw/main/check_docker_registry.sh)
